...
public class Test02Stream {
	...
	public void test01() {
		...
		Map<Integer, Employee> collect = employees.stream().collect(Collectors.toMap(Employee::getId, x -> x));
	...
	public void test10() {
		...
		Optional<Integer> max = s1.stream().max(Comparator.comparingInt(a -> a));
